...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'map' to transform each element", function () {
    ...
    /* map - Produces a new array of values by 
    mapping each value in list through a transformation function */
  ...
  it("should use range to generate an array", function() {
    ...
    //range - Returns a list of integers from start (inclusive) to stop (exclusive), 
  ...
  it("should use flatten to make nested arrays easy to work with", function() {
    //fatten - Flattens a nested array (the nesting can be to any depth)
      expect(_([ [1, 2], [3, 4] ]).flatten()).toEqual([1, 2, 3, 4]);
  });

  it("should use chain() ... .value() to use multiple higher order functions", function() {
    //chains - Returns a wrapped object. 
